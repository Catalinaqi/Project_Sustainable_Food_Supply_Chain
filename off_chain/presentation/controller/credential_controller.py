...
class ControllerAutenticazione:
    ...
    @staticmethod
    def registrazione(username, password, tipo, indirizzo):
        ...
        try:
            ...
            repo1.inserisci_credenziali_e_azienda(username, password, tipo, indirizzo, secret_key)
    ...
    def login(username, password, otp_code=None):
        try:
            ...
            credenziali = repo.get_lista_credenziali()
        ...
        if (username, password) not in [(t[1], t[2]) for t in credenziali]:
            ...
            for credenziale in credenziali:
                if credenziale[1] == username and credenziale[2] == password:
                    ...
                    azienda = repo.get_azienda_by_id(id_)
